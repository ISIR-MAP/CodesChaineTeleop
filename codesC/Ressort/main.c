      ...
      if (bufread[0] == 5)
        {
            ...
            sprintf(message,"%f %f",torq, posSM_d);
...
/* ********************************************** RESSORT *************************************************************************** */
    ...
    else
    {
        ...
        {
            torq = 2*cos((posSM_d-15)*4*2*3.14);
        }
         if(posSM_d >= -20 && posSM_d <= -10)
        {
            ftime(&now);
            torq = 2*cos((now.millitm)*800*2*3.14);
...
/* ********************************************FIN MUR AMORTI************************************************************************** */
    ...
    if(diff > 7000) {
        torq = -80+20*cos((diff)*0.001*50*2*3.14);
    }
    if(diff > 7200) {
        torq = -80+20*cos((diff)*0.001*100*2*3.14);
    }
    if(diff > 7400) {
        torq = -80+20*cos((diff)*0.001*200*2*3.14);
    }
    if(diff > 7600) {
        torq = -80+20*cos((diff)*0.001*220*2*3.14);
    }
    if(diff > 7800) {
        torq = -80+20*cos((diff)*0.001*440*2*3.14);
    }
    if(diff > 8000) {
        torq = -80.0-20;
        if(diff % 2 ==0)
